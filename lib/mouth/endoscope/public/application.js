...
var DashboardItemView = Backbone.View.extend({
  ...
  initialize: function(opts) {
    _.bindAll(this, 'render', 'onChangeModel', 'onRemoveModel', 'onClickDelete', 'onKeyName', 'chosen', 'onClickSave', 'onClickCancel');
...
var DashboardListView = Backbone.View.extend({
  ...
  onClickChooser: function(evt) {
    ...
    view.chosen();
    window.history.pushState({dashboardId: view.model.id}, view.model.name, "/dashboards/" + view.model.id);
  },
  ...
  onResetDashboards: function(col) {
    ...
    currentView.chosen();
    window.history.replaceState({dashboardId: currentModel.id}, currentModel.name, "/dashboards/" + currentModel.id);
  },
...
var GraphView = Backbone.View.extend({
  ...
  initialize: function(opts) {
    _.bindAll(this, 'render', 'onDragStop', 'onClickEdit', 'onClickPick', 'onCreateModel', 'onClickDelete', 'onRemoveModel', 'onPick', 'onCancelPick', 'onDateRangeChanged');
