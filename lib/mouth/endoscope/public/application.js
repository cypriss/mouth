...
var Graph = Backbone.Model.extend({
  ...
  setSource: function(source) {
    ...
    if (s0) {
      ...
      s = [{}];
      s0 = s[0];
      s0.kind = 'line'; //todo: switch to candle for timer
      s0.color = 'blue';
      s0.source = source;
      this.set({series: s});
    }
...
var GraphView = Backbone.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, 'render', 'onDragStop', 'onClickEdit', 'onChangeSource');
    this.mode = 'front';
  },
  ...
  renderBack: function() {
    ...
    el.html('<div class="graph-header"><span></span> <a href="#" class="edit">Edit</a></div><div class="graph-back"><select class="data-source"></select></div>');
  ...
  loadStreams: function() {
    ...
    $.getJSON('/streams', {}, function(data) {
      ...
      //{"collection":"mouth_auth","kind":"counter","key":"inline_logged_in"}
