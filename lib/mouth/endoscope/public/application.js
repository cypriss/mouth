...
var Graph = Backbone.Model.extend({
  ...
  matchesSource: function(source) {
    ...
    if (s0) {
      return s0.source.kind == source.kind && s0.source.key == source.key && s0.source.collection == source.collection;
    }
...
var GraphView = Backbone.View.extend({
  ...
  render: function() {
    ...
    template = (this.mode === 'front') ? '<div class="graph-header"><span></span> <a href="#" class="edit">Edit</a></div><div class="graph-body"></div>' :
